...
const DisplayFactionWinStats = (props) => {
  ...
  return (
    <div>
      <h1>Winning Faction: {faction}</h1>
      <h2 >Win Percentage {Math.round(countDataW / (countDataW + countDataL)*100)}%</h2>
...
export default DisplayFactionWinStats;